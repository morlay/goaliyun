...
func (req *CreateLoadBalancerHTTPSListenerRequest) Invoke(client goaliyun.Client) (*CreateLoadBalancerHTTPSListenerResponse, error) {
	resp := &CreateLoadBalancerHTTPSListenerResponse{}
	err := client.Request("slb", "CreateLoadBalancerHTTPSListener", "2014-05-15", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
