...
func (req *SetLoadBalancerHTTPSListenerAttributeRequest) Invoke(client goaliyun.Client) (*SetLoadBalancerHTTPSListenerAttributeResponse, error) {
	resp := &SetLoadBalancerHTTPSListenerAttributeResponse{}
	err := client.Request("slb", "SetLoadBalancerHTTPSListenerAttribute", "2014-05-15", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
