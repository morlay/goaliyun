...
func (req *DescribeReplicasRequest) Invoke(client goaliyun.Client) (*DescribeReplicasResponse, error) {
	...
	err := client.Request("r-kvstore", "DescribeReplicas", "2015-01-01", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
...
type DescribeReplicasItems struct {
	...
	ReplicaMode        goaliyun.String
	DomainMode         goaliyun.String
