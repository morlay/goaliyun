...
func (req *DescribeEipAddressesRequest) Invoke(client goaliyun.Client) (*DescribeEipAddressesResponse, error) {
	...
	err := client.Request("vpc", "DescribeEipAddresses", "2016-04-28", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
...
type DescribeEipAddressesEipAddress struct {
	...
	InstanceRegionId     goaliyun.String
	ChargeType           goaliyun.String
	ExpiredTime          goaliyun.String
	Name                 goaliyun.String
	ISP                  goaliyun.String
	Descritpion          goaliyun.String
	BandwidthPackageId   goaliyun.String
	BandwidthPackageType goaliyun.String
...
type DescribeEipAddressesAvailableRegionList []goaliyun.String
