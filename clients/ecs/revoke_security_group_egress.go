...
func (req *RevokeSecurityGroupEgressRequest) Invoke(client goaliyun.Client) (*RevokeSecurityGroupEgressResponse, error) {
	resp := &RevokeSecurityGroupEgressResponse{}
	err := client.Request("ecs", "RevokeSecurityGroupEgress", "2014-05-26", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
