...
func (req *ModifySecurityGroupRuleRequest) Invoke(client goaliyun.Client) (*ModifySecurityGroupRuleResponse, error) {
	resp := &ModifySecurityGroupRuleResponse{}
	err := client.Request("ecs", "ModifySecurityGroupRule", "2014-05-26", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
