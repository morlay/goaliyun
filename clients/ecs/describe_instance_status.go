...
func (req *DescribeInstanceStatusRequest) Invoke(client goaliyun.Client) (*DescribeInstanceStatusResponse, error) {
	resp := &DescribeInstanceStatusResponse{}
	err := client.Request("ecs", "DescribeInstanceStatus", "2014-05-26", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
