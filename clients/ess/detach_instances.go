...
func (req *DetachInstancesRequest) Invoke(client goaliyun.Client) (*DetachInstancesResponse, error) {
	resp := &DetachInstancesResponse{}
	err := client.Request("ess", "DetachInstances", "2014-08-28", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
