...
func (req *AttachInstancesRequest) Invoke(client goaliyun.Client) (*AttachInstancesResponse, error) {
	resp := &AttachInstancesResponse{}
	err := client.Request("ess", "AttachInstances", "2014-08-28", req.RegionId, "", "").Do(req, resp)
	return resp, err
}
